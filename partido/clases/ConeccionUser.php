      ...
      try {
          ...
          switch ($condicion) 
          {
              case "INSERT":
                  ...
                  $msgok = "Usuario Insertados";
                  
                  break;
              case "DELETE":
                  $msgerror = "No se ha Podido Eliminar Usuario";                  
                  $msgok = "Usuario Eliminados";
                  break;
              case "UPDATE":
                  $msgerror = "No se ha Podido Actualizar Usuario";                  
                  $msgok = "Usuario Actualizados";
                  break;
              default:
