...
<header>
<img src="img/logo.png" style="width=150px height=150px " ><br>
<h1><center>    Tribunal Electronico Electoral -TEE<br>
<span>¡El Salvador!</span></h1>
<p>Elecciones El Salvador</p></center>
</header>
  ...
  <?php if (isset($_REQUEST['msg'])) { ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-2">
                            ...
                            <?php  print "DUI no existe :(  Ó Ya Voto :@";?> 
                            </div>
